...
Deserializers["CTA"] = function (request, data, root) {
  var i784 = root || request.c( 'CTA' )
  var i785 = data
  return i784
}

Deserializers["UnityEngine.UI.Button"] = function (request, data, root) {
  var i786 = root || request.c( 'UnityEngine.UI.Button' )
  var i787 = data
  i786.m_OnClick = request.d('UnityEngine.UI.Button+ButtonClickedEvent', i787[0], i786.m_OnClick)
  i786.m_Navigation = request.d('UnityEngine.UI.Navigation', i787[1], i786.m_Navigation)
  i786.m_Transition = i787[2]
  i786.m_Colors = request.d('UnityEngine.UI.ColorBlock', i787[3], i786.m_Colors)
  i786.m_SpriteState = request.d('UnityEngine.UI.SpriteState', i787[4], i786.m_SpriteState)
  i786.m_AnimationTriggers = request.d('UnityEngine.UI.AnimationTriggers', i787[5], i786.m_AnimationTriggers)
  i786.m_Interactable = !!i787[6]
  request.r(i787[7], i787[8], 0, i786, 'm_TargetGraphic')
  return i786
}

Deserializers["UnityEngine.UI.Button+ButtonClickedEvent"] = function (request, data, root) {
  var i788 = root || request.c( 'UnityEngine.UI.Button+ButtonClickedEvent' )
  var i789 = data
...
Deserializers["UnityEngine.Events.PersistentCallGroup"] = function (request, data, root) {
  var i790 = root || request.c( 'UnityEngine.Events.PersistentCallGroup' )
  var i791 = data
  var i793 = i791[0]
  var i792 = new (System.Collections.Generic.List$1(Bridge.ns('UnityEngine.Events.PersistentCall')))
  for(var i = 0; i < i793.length; i += 1) {
    i792.add(request.d('UnityEngine.Events.PersistentCall', i793[i + 0]));
  }
  i790.m_Calls = i792
  return i790
}
...
Deserializers["UnityEngine.Events.PersistentCall"] = function (request, data, root) {
  var i796 = root || request.c( 'UnityEngine.Events.PersistentCall' )
  var i797 = data
  request.r(i797[0], i797[1], 0, i796, 'm_Target')
  i796.m_TargetAssemblyTypeName = i797[2]
  i796.m_MethodName = i797[3]
  i796.m_Mode = i797[4]
  i796.m_Arguments = request.d('UnityEngine.Events.ArgumentCache', i797[5], i796.m_Arguments)
  i796.m_CallState = i797[6]
  return i796
}

Deserializers["UnityEngine.Events.ArgumentCache"] = function (request, data, root) {
  var i798 = root || request.c( 'UnityEngine.Events.ArgumentCache' )
  var i799 = data
  request.r(i799[0], i799[1], 0, i798, 'm_ObjectArgument')
  i798.m_ObjectArgumentAssemblyTypeName = i799[2]
  i798.m_IntArgument = i799[3]
  i798.m_FloatArgument = i799[4]
  i798.m_StringArgument = i799[5]
  i798.m_BoolArgument = !!i799[6]
  return i798
}

Deserializers["UnityEngine.UI.Navigation"] = function (request, data, root) {
  var i800 = root || request.c( 'UnityEngine.UI.Navigation' )
  var i801 = data
  i800.m_Mode = i801[0]
  i800.m_WrapAround = !!i801[1]
  request.r(i801[2], i801[3], 0, i800, 'm_SelectOnUp')
  request.r(i801[4], i801[5], 0, i800, 'm_SelectOnDown')
  request.r(i801[6], i801[7], 0, i800, 'm_SelectOnLeft')
  request.r(i801[8], i801[9], 0, i800, 'm_SelectOnRight')
  return i800
}

Deserializers["UnityEngine.UI.ColorBlock"] = function (request, data, root) {
  var i802 = root || request.c( 'UnityEngine.UI.ColorBlock' )
  var i803 = data
  i802.m_NormalColor = new pc.Color(i803[0], i803[1], i803[2], i803[3])
  i802.m_HighlightedColor = new pc.Color(i803[4], i803[5], i803[6], i803[7])
  i802.m_PressedColor = new pc.Color(i803[8], i803[9], i803[10], i803[11])
  i802.m_SelectedColor = new pc.Color(i803[12], i803[13], i803[14], i803[15])
  i802.m_DisabledColor = new pc.Color(i803[16], i803[17], i803[18], i803[19])
  i802.m_ColorMultiplier = i803[20]
  i802.m_FadeDuration = i803[21]
  return i802
}

Deserializers["UnityEngine.UI.SpriteState"] = function (request, data, root) {
  var i804 = root || request.c( 'UnityEngine.UI.SpriteState' )
  var i805 = data
  request.r(i805[0], i805[1], 0, i804, 'm_HighlightedSprite')
  request.r(i805[2], i805[3], 0, i804, 'm_PressedSprite')
  request.r(i805[4], i805[5], 0, i804, 'm_SelectedSprite')
  request.r(i805[6], i805[7], 0, i804, 'm_DisabledSprite')
  return i804
}

Deserializers["UnityEngine.UI.AnimationTriggers"] = function (request, data, root) {
  var i806 = root || request.c( 'UnityEngine.UI.AnimationTriggers' )
  var i807 = data
  i806.m_NormalTrigger = i807[0]
  i806.m_HighlightedTrigger = i807[1]
  i806.m_PressedTrigger = i807[2]
  i806.m_SelectedTrigger = i807[3]
  i806.m_DisabledTrigger = i807[4]
  return i806
}

Deserializers["VariableJoystick"] = function (request, data, root) {
  var i808 = root || request.c( 'VariableJoystick' )
  var i809 = data
  i808.moveThreshold = i809[0]
  i808.joystickType = i809[1]
  request.r(i809[2], i809[3], 0, i808, 'background')
  i808.handleRange = i809[4]
  i808.deadZone = i809[5]
  i808.axisOptions = i809[6]
  i808.snapX = !!i809[7]
  i808.snapY = !!i809[8]
  request.r(i809[9], i809[10], 0, i808, '_handle')
  return i808
}

Deserializers["_Project.Code.Core.Animations.BreathAnimation"] = function (request, data, root) {
  var i810 = root || request.c( '_Project.Code.Core.Animations.BreathAnimation' )
  var i811 = data
  i810._scaleFactor = i811[0]
  return i810
}
...
Deserializers.applicationIdentifier = "com.DefaultCompany.SpongeBob-Playable";
...
Deserializers.buildID = "62adb4a4-0aec-46cf-b34f-e806042be4d8";
